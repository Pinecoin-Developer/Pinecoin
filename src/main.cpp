...
const string strMessageMagic = "pinecoin Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);  // 90% yearly interest 
