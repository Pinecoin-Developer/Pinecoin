...
int nAnonymizepinecoinAmount = 1000;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "pinecoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "pinecoind.pid"));
