...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #pinecoincoinTEST\r");
            Send(hSocket, "WHO #pinecoincoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #pinecoincoin\n");
            // randomly join #pinecoincoin00-#pinecoincoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #pinecoincoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #pinecoincoin%02d\r", channel_number).c_str());
        };
